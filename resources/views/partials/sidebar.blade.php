    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="/auth/login" target="_top">
                            <i class="nav-icon icon-star"></i> Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/auth/register" target="_top">
                            <i class="nav-icon icon-star"></i> Register</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/errors/404" target="_top">
                            <i class="nav-icon icon-star"></i> Error 404</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/errors/500" target="_top">
